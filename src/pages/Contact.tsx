...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Контакты | Виктор Руди</title>
        <meta
          name="description"
          content="Свяжитесь со мной для обсуждения проектов и сотрудничества."
        />
      </Helmet>
      ...
      <div className="max-w-4xl mx-auto animate-fadeIn">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {contacts.map((contact) => (
            <div key={contact.title} className="card p-6 text-center hover:scale-[1.02] transition-transform duration-300">
